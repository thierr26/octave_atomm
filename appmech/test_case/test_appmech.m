...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{s} =} test_appmech ()
##
## Run test case for toolbox "appmech", return results as a structure.
##
## @code{@var{s} = test_appmech ()} actually runs a
...
## "test_appmech" (function name, given by function @code{mfilename}).
##
## @item @var{test_routine}
## Cell array of handles to local functions (test routines) written
## specifically to test the toolbox "appmech".
## @end table
##
